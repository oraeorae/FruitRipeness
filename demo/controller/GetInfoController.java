...
public class GetInfoController {
     ...
     *  secret
     * */
    public static String appid = "wx3c9e9aca7747c681";
    public static String secret = "fa4a0367b7e4208912998e98b8084daa" ;
    ...
    public @ResponseBody Map<String,Object> login(@RequestParam("code") String code,@RequestParam("avatarUrl") String avatarUrl,@RequestParam("name") String name) {
